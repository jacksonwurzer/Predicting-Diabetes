...
Description:
------------
This script implements a fully connected feedforward neural network from scratch. 
...
Note:
-----
This is an educational example to demonstrate neural network implementation without deep learning frameworks 
...
def train(X_train, Y_train, input_size=8, hidden_size1=15, hidden_size2=15, output_size=2, alpha=0.23, epochs=100):
...
W1, b1, W2, b2, W3, b3, errors = train(X_train, Y_train, alpha=0.23, epochs=100)
